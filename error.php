	...
	<main id="main">
		<div class="container">
			<section id="main-content" role="main">
				<article itemProp="hasPart" itemScope itemType="https://schema.org/Article"><h1>Error</h1><h3><?php echo $this->_error->message ?? "Unknown error"; ?></h3><div itemProp="articleBody"><?php echo $this->_error->description ?? ""; ?></div></article>
			</section>
		</div>
	</main>
