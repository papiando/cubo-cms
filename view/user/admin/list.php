...
<form id="filter-form" class="form">
	<div class="form-row d-flex justify-content-between">
		...
		<div class="col-3">
			<?php
				$filter = array('id'=>'filter-role','label'=>'Role','prefix'=>'','value'=>ROLE_ANY);
				include($this->_sharedPath.'filter-role.php'); ?>
		</div>
	</div>
</form>
<p id="filter-info"></p>
...
?>		<tr class="table-item d-none" data-item="<?php echo htmlentities(json_encode($item)); ?>" data-filter="none">
			...
			<td class="align-middle"><?php include($this->_sharedPath.'show-role.php'); ?></td>
			<td class="text-right align-middle">
