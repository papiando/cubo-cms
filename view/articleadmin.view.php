...
class ArticleAdminView extends View {
	protected $controller;		// **************** Might be the same as $class
	...
	public function adminEdit() {
		$html = '<h1>Edit Article</h1><form class="form-edit" action="" method="post">';
		...
		$html .= '<div class="form-group grid-column-2"><label for="html">Article Content</label><textarea name="-html" id="html" class="form-control text-html" placeholder="Contents" rows="12" required>'.$this->_data->html.'</textarea></div><div>';
		...
		$html .= '<div class="form-group">'.$this->selectImage(array('id'=>'image','label'=>'Image','prefix'=>'-','value'=>$this->_data->image)).'</div></div><div>';
