...
<head>
	<title itemprop="name headline"><cube:param name='site_name' /></title>
	<base itemprop="url" href="<cube:param name='base_url' />/admin" />
	<meta charset="utf-8" />
	<meta name="application_name" content="<cube:param name='site_name' />" />
	<meta name="generator" content="<cube:param name='generator' />" />
	...
	<link rel="icon" type="image/png" href="/vendor/cube/cube.png" />
...
<body>
	<nav id="navigation" class="navbar navbar-toggleable-md navbar-dark bg-primary fixed-top">
		...
		<a class="navbar-brand" href="/"><img src="/vendor/cube/cube.png" /></a>
